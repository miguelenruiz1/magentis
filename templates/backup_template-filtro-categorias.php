          ...
          <div class="contenedor-filtro">
              <div class="row pt-4">
                ...
                <div class="col">
                        ...
                        <div class="container-clearFilters">
                          <button type="button" name="limpiar_filtros" id="limpiarFiltrosButton" class="mi-button-clear" style="
    float: right;">Limpiar filtros</button>
                        </div>
              ...
              <div id="collapseSegments" class="accordion-collapse collapse show" aria-labelledby="headingSegments">
                <div class="accordion-body">
                  ...
                  foreach ($segment_categories as $segment_category) {
                    ...
                    echo '<label><input type="radio" name="filter_categories_seg" value="' . esc_attr($segment_category->term_id) . '" class="mi-radio" id="segment_category_id_' . esc_attr($segment_category->term_id) . '"> ' . esc_html($segment_category->name) . '</label><br>';
                    ...
                    foreach ($segment_children as $segment_child) {
                      echo '<label style="margin-left: 20px;"><input type="radio" name="filter_categories_seg" value="' . esc_attr($segment_child->term_id) . '" class="mi-radio" id="segment_category_id_' . esc_attr($segment_child->term_id) . '"> ' . esc_html($segment_child->name) . '</label><br>';
                    }
                  }
                  ?>
                </div>
      ...
      <div class="accordion-item style-perzon">
        ...
        <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingOne">
          <div class="accordion-body">
            ...
            // Mostrar checkboxes para las categorías de "category"
            foreach ($category_terms as $category_term) {
              echo '<label class="checkeable-prueba"><input type="checkbox" name="filter_categories" value="' . esc_attr($category_term->term_id) . '" id="segment_category_id_' . esc_attr($category_term->term_id) . '" class="mi-checkbox" id="segment_category_id_' . esc_attr($category_term->term_id) . '"><h3> ' . esc_html($category_term->name) . '</h3></label><br>';
              ...
              // Mostrar checkboxes para los hijos de la categoría de "category"
              foreach ($category_children as $category_child) {
                echo '<label class="checkeable-prueba""><input type="checkbox" name="filter_categories" value="' . esc_attr($category_child->term_id) . '" class="mi-checkbox" id="segment_category_id_' . esc_attr($category_child->term_id) . '"><h3> ' . esc_html($category_child->name) . '</h3></label><br>';
              }
            }
            ?>
          </div>
      ...
      <div class="accordion-item style-perzon">
        ...
        <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingTwo">
          <div class="accordion-body">
            ...
            // Mostrar checkboxes para las categorías de "product_final"
            foreach ($product_final_terms as $product_final_term) {
              echo '<label class="checkeable-prueba"><input type="checkbox" name="filter_product_final" value="' . esc_attr($product_final_term->term_id) . '" id="segment_category_id_' . esc_attr($product_final_term->term_id) . '" class="mi-checkbox filter_product_final"><h3>' . esc_html($product_final_term->name) . '</h3></label><br>';
              ...
              // Mostrar checkboxes para los hijos de la categoría de "product_final"
              foreach ($product_final_children as $product_final_child) {
                echo '<label class="checkeable-prueba" ><input type="checkbox" name="filter_product_final" value="' . esc_attr($product_final_child->term_id) . '" id="segment_category_id_' . esc_attr($product_final_term->term_id) . '" class="mi-checkbox filter_product_final"><h3>' . esc_html($product_final_child->name) . '</h3></label><br>';
              }
            }
            ?>
          </div>
        ...
        <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingThree">
          <div class="accordion-body">
            ...
            foreach ($technical_need_terms as $technical_need_term) {
              ...
              echo '<label class="checkeable-prueba"><input type="checkbox" name="filter_technical_need" value="' . esc_attr($technical_need_term->term_id) . '" id="segment_category_id_' . esc_attr($technical_need_term->term_id) . '" class="mi-checkbox"><h3>' . esc_html($technical_need_term->name) . '</h3></label><br>';
              ...
              // Mostrar checkboxes para los hijos de la categoría de "product_technicalneed"
              foreach ($technical_need_children as $technical_need_child) {
                echo '<label class="checkeable-prueba"><input type="checkbox" name="filter_technical_need" value="' . esc_attr($technical_need_child->term_id) . '"  id="segment_category_id_' . esc_attr($technical_need_term->term_id) . '" class="mi-checkbox"><h3>' . esc_html($technical_need_child->name) . '</h3></label><br>';
              }
            }
            ?>
          </div>
      ...
      <div class="accordion-item style-perzon">
        ...
        <div id="panelsStayOpen-collapseFour" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingOne">
          <div class="accordion-body">
            ...
            // Mostrar checkboxes para las categorías de "functional_group"
            foreach ($functional_group_terms as $functional_group_term) {
              echo '<label class="checkeable-prueba"><input type="checkbox" name="filter_functional_group" value="' . esc_attr($functional_group_term->term_id) . '"  id="segment_category_id_' . esc_attr($functional_group_term->term_id) . '" class="mi-checkbox"><h3>' . esc_html($functional_group_term->name) . '</h3></label><br>';
              ...
              // Mostrar checkboxes para los hijos de la categoría de "functional_group"
              foreach ($functional_group_children as $functional_group_child) {
                echo '<label class="checkeable-prueba"><input type="checkbox" name="filter_functional_group" value="' . esc_attr($functional_group_child->term_id) . '" id="segment_category_id_' . esc_attr($functional_group_term->term_id) . '" class="mi-checkbox"><h3>' . esc_html($functional_group_child->name) . '</h3></label><br>';
              }
            }
            ?>
          </div>
      ...
      <div class="accordion-item style-perzon">
        ...
        <div id="panelsStayOpen-collapseFive" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingOne">
          <div class="accordion-body">
            ...
            // Mostrar checkboxes para las categorías de "functional_subgroup"
            foreach ($functional_subgroup_terms as $functional_subgroup_term) {
              echo '<label class="checkeable-prueba"><input type="checkbox" name="filter_functional_subgroup" value="' . esc_attr($functional_subgroup_term->term_id) . '" id="segment_category_id_' . esc_attr($functional_subgroup_term->term_id) . '" class="mi-checkbox"><h3>' . esc_html($functional_subgroup_term->name) . '</h3></label><br>';
              ...
              // Mostrar checkboxes para los hijos de la categoría de "functional_subgroup"
              foreach ($functional_subgroup_children as $functional_subgroup_child) {
                echo '<label class="checkeable-prueba"><input type="checkbox" name="filter_functional_subgroup" value="' . esc_attr($functional_subgroup_child->term_id) . '" id="segment_category_id_' . esc_attr($functional_subgroup_term->term_id) . '" class="mi-checkbox"><h3>' . esc_html($functional_subgroup_child->name) . '</h3></label><br>';
              }
            }
            ?>
          </div>
      ...
      <div class="accordion-item style-perzon">
        ...
        <div id="panelsStayOpen-collapseSix" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingOne">
          <div class="accordion-body">
            ...
            // Mostrar checkboxes para las categorías de "magentis_brand"
            foreach ($magentis_brand_terms as $magentis_brand_term) {
              echo '<label class="checkeable-prueba"><input type="checkbox" name="filter_magentis_brand" value="' . esc_attr($magentis_brand_term->term_id) . '"  id="segment_category_id_' . esc_attr($magentis_brand_term->term_id) . '" class="mi-checkbox"><h3>' . esc_html($magentis_brand_term->name) . '</h3></label><br>';
              ...
              // Mostrar checkboxes para los hijos de la categoría de "magentis_brand"
              foreach ($magentis_brand_children as $magentis_brand_child) {
                echo '<label class="checkeable-prueba"><input type="checkbox" name="filter_magentis_brand" value="' . esc_attr($magentis_brand_child->term_id) . '" id="segment_category_id_' . esc_attr($magentis_brand_term->term_id) . '" class="mi-checkbox"><h3>' . esc_html($magentis_brand_child->name) . '</h3></label><br>';
              }
            }
            ?>
          </div>
      ...
      <div class="accordion-item style-perzon">
        ...
        <div id="panelsStayOpen-collapseSeven" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingOne">
          <div class="accordion-body">
            ...
            // Mostrar checkboxes para las categorías de "distribucion"
            foreach ($distribucion_terms as $distribucion_term) {
              echo '<label class="checkeable-prueba"><input type="checkbox" name="filter_distribucion" value="' . esc_attr($distribucion_term->term_id) . '" id="segment_category_id_' . esc_attr($distribucion_term->term_id) . '" class="mi-checkbox"><h3>' . esc_html($distribucion_term->name) . '</h3></label><br>';
              ...
              // Mostrar checkboxes para los hijos de la categoría de "distribucion"
              foreach ($distribucion_children as $distribucion_child) {
                echo '<label class="checkeable-prueba"><input type="checkbox" name="filter_distribucion" value="' . esc_attr($distribucion_child->term_id) . '" id="segment_category_id_' . esc_attr($distribucion_term->term_id) . '" class="mi-checkbox"><h3>' . esc_html($distribucion_child->name) . '</h3></label><br>';
              }
            }
            ?>
          </div>
...
<a href="#" id="volver_arriba" class="volverbtn">Volver arriba!</a>
